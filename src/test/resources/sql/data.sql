...
INSERT INTO ARTICLE(author_id, title, contents) VALUES (1, '첫번째 게시물입니다.', '이건 첫번째 게시물이에요.');
INSERT INTO ARTICLE(author_id, title, contents) VALUES (2, '테스트 게시물입니다.', '이건 테스트용 게시물이에요. 잘 작성됐나요?');
INSERT INTO ARTICLE(author_id, title, contents) VALUES (1, '또 다른 테스트 게시물입니다.', '내용을 뭐라고 작성하면 좋을까요?');
INSERT INTO ARTICLE(author_id, title, contents) VALUES (3, '주말에 눈 또는 비가 올지도 모른다고 해요.', '그 날 날씨가 맑아야만 했는데...');
