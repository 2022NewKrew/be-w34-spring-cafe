...
public class UserService {
    ...
    public User getLoggedInUser(HttpSession session) throws IllegalAccessException{
    ...
    public void editUserInfo(String originNickname, String newEmail, String newNickName){
        userRepository.editUserInfo(originNickname, newEmail, newNickName);
    }
