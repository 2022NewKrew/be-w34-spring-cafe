...
public class JdbcTemplateUserRepository implements UserRepository{
    ...
    public void edit(User user) {
        String query = "update users set nickname=?,email=?,password=? where userid=?";
        jdbcTemplate.update(query,user.getNickname(),user.getEmail(),user.getPassword(),user.getUserId());
    }
