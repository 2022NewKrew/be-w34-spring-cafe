...
public class QuestionController {
    ...
    @PostMapping("/create")
    public String insertQuestion(@ModelAttribute("question")
                                 @Valid QuestionCreateDto questionCreateDto, Model model) throws BaseException, SQLException {
    ...
    public String updateQuestion(@PathVariable("id") Long id, @Valid
    @ModelAttribute("question") QuestionUpdateDto questionUpdateDto, Model model) throws BaseException {
        Long memberId = getMemberId();
    ...
    private List<QuestionDto> getQuestionDtos(Long memberId) {
        return questionService.findAll()
                ...
                .map(
                        q -> {
                            ...
                            question.setThisIsMine(memberId.equals(q.getMemberId()));
